...
led_strip_t* led_strip_setup(const led_strip_setup_t *setup){
    esp_err_t err = ESP_OK;
    rmt_config_t config = RMT_DEFAULT_CONFIG_TX(setup->TX_Pin,setup->RMT_channel);
    //rmt_config_t config = RMT_DEFAULT_CONFIG_TX(RMT_CHANNEL_0, 27);
    ...
    led_strip_config_t strip_config = LED_STRIP_DEFAULT_CONFIG(setup->LED_Count, (led_strip_dev_t)config.channel);
